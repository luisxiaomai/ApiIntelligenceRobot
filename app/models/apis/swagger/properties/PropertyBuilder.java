...
import models.apis.swagger.ArrayModel;
import models.apis.swagger.Model;
import models.apis.swagger.ModelImpl;
...
public class PropertyBuilder {
    ...
    private enum Processor {
        ...
        BYTE_ARRAY(models.apis.swagger.properties.ByteArrayProperty.class) {
            @Override
            protected boolean isType(String type, String format) {
                return models.apis.swagger.properties.ByteArrayProperty.isType(type, format);
            }

            @Override
            protected models.apis.swagger.properties.ByteArrayProperty create() {
                return new models.apis.swagger.properties.ByteArrayProperty();
            }
        },
        ...
        DATE_TIME(models.apis.swagger.properties.DateTimeProperty.class) {
            @Override
            protected boolean isType(String type, String format) {
                return models.apis.swagger.properties.DateTimeProperty.isType(type, format);
            }

            @Override
            protected models.apis.swagger.properties.DateTimeProperty create() {
                return new models.apis.swagger.properties.DateTimeProperty();
            }
        },
        ...
        INTEGER(models.apis.swagger.properties.BaseIntegerProperty.class) {
            @Override
            protected boolean isType(String type, String format) {
                return models.apis.swagger.properties.BaseIntegerProperty.isType(type, format);
            }

            @Override
            protected models.apis.swagger.properties.BaseIntegerProperty create() {
                return new models.apis.swagger.properties.BaseIntegerProperty();
            }

            @Override
            public Property merge(Property property, Map<PropertyId, Object> args) {
                super.merge(property, args);
                if (property instanceof models.apis.swagger.properties.BaseIntegerProperty) {
                    final models.apis.swagger.properties.BaseIntegerProperty resolved = (models.apis.swagger.properties.BaseIntegerProperty) property;
                    mergeNumeric(resolved, args);
                }
                return property;
            }
        ...
        protected <N extends models.apis.swagger.properties.AbstractNumericProperty> N mergeNumeric(N property, Map<PropertyId, Object> args) {
        ...
        public Property merge(Property property, Map<PropertyId, Object> args) {
            ...
            if (property instanceof models.apis.swagger.properties.AbstractProperty) {
                final models.apis.swagger.properties.AbstractProperty resolved = (models.apis.swagger.properties.AbstractProperty) property;
                ...
                if(args.containsKey(PropertyId.ENUM)) {
                    ...
                    if(values != null) {
                       ...
                       if(property instanceof models.apis.swagger.properties.DateTimeProperty) {
                         models.apis.swagger.properties.DateTimeProperty p = (models.apis.swagger.properties.DateTimeProperty) property;
                         for(String value : values) {
                           try {
                             p._enum(value);
                           }
